export default function HorrorMovies() {
  ...
  const movies: Record<string, Movie[]> = {
    ...
    "2010s": [
      ...
      { title: "Escape Room", year: 2019, rating: 6.4, country: "USA", url: "https://www.hoopladigital.com/movie/escape-room-taylor-russell/14044308", source: "hoopla" },
      ...
      { title: "Krampus", year: 2015, rating: 6.2, country: "USA", url: "https://www.hoopladigital.com/movie/krampus-adam-scott/14044288", source: "hoopla" },
    ],
    "2000s": [
      ...
      { title: "Let the Right One In", year: 2008, rating: 7.8, country: "Sweden", url: "https://www.hoopladigital.com/movie/let-the-right-one-in-kare-hedebrant/11049580", source: "hoopla" },
      { title: "Battle Royale", year: 2000, rating: 7.5, country: "Japan", url: "https://www.kanopy.com/en/mppl/video/11335693", source: "kanopy" },
      { title: "Rec", year: 2007, rating: 7.4, country: "Spain", url: "https://www.hoopladigital.com/movie/rec-manuela-velasco/11119024", source: "hoopla" },
      ...
      { title: "Lake Mungo", year: 2008, rating: 6.2, country: "Australia", url: "https://www.hoopladigital.com/movie/lake-mungo-rosie-traynor/11028920", source: "hoopla" },
    ...
    "1930s": [
      { title: "Frankenstein", year: 1931, rating: 7.8, country: "USA", url: "https://www.hoopladigital.com/movie/frankenstein-robert-foxworth/10966670", source: "hoopla" },
      { title: "Dracula", year: 1931, rating: 7.4, country: "USA", url: "https://www.hoopladigital.com/movie/dracula-jack-palance/10966752", source: "hoopla" },
    ],
    "1920s": [
      ...
      { title: "Nosferatu", year: 1922, rating: 7.9, country: "Germany", url: "https://www.hoopladigital.com/movie/nosferatu-max-schreck/12307030", source: "hoopla" },
    ],
  };
  ...
  const decadeLabels: { [key: string]: { emoji: string; title: string } } = {
    ...
    "1930s": { emoji: "🧛", title: "1930s (Classic)" },
