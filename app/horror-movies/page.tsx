export default function HorrorMovies() {
  ...
  // Calculate totals
  const totalCount = Object.values(movies).flat().length;
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Available on Kanopy | Organized by Decade | {totalCount} Films Total
          </p>
        </header>
        ...
        <footer className="mt-16 text-center text-gray-400 text-sm border-t border-gray-800 pt-8">
          ...
          <p className="mb-4">
            Films link directly to Kanopy for streaming
          </p>
...
export const metadata = {
  ...
  description:
    "Curated list of horror movies with 6.0+ IMDb ratings available on Kanopy, organized by decade. From silent films to modern horror.",
  openGraph: {
    title: "Horror Movies on Kanopy - Curated List",
    description: "Verified horror films with 6.0+ IMDb ratings from Kanopy library",
  },
};
